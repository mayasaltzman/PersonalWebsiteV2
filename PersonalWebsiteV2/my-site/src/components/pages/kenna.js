...
const kenna = () => {
    return (
        <div>
            ...
            <img id='kenna-img' src='/assets/kennagroup.jpg' alt='group of people in halloween costumes' />
            ...
            <div id='pretext' class="text-sections">
                ...
                <img src='/assets/kenna_rainbow.png' id='kenna-img' alt='infographic showing kennas values'></img>
            </div>
            ...
            <section id='wt1' class="text-sections">
                ...
                <section id='goals' class="text-sections">
                    ...
                    <img id='kenna-img' src='/assets/baseball.png' alt='selfie of four people at baseball game'></img>
                </section>
            </section>
            ...
            <section id='ca' class="text-sections">
                ...
                <img src='/assets/nick_daniel.png' alt='three people posed like super heros in halloween costumes' id='kenna-img' className='daniel'/>
            </section>
