...
const kenna = () => {
    return (
        <div>
            ...
            <h2 class='kenna-header2'>Introduction</h2>
            <div id='pretext' class="text-sections">
                <p>
                    ...
                    on
                    was
                    used to help those working in agriculture. <br /><br />
            ...
            <h2 class='kenna-header2'>About Employer</h2>

            <div class="text-sections">
                <p>Kenna is a marketing solutions provider specializing in customer experience management. Founded in 1985 as AppliCan Marketing and rebranded as Kenna 2002.
                    For over three decades Kenna has provided their clients data driven solutions and software with an emphasis on customer first thinking. <br /><br />
                    Today Kenna works with BASF to create software for clients. For the past two decades Kenna has helped BASF build loyal customer relationships which have increased market success. This is done by gaining the trust of growers through their experience with the brand.
                    <br /><br />The current CEO of Kenna is Jeffery Bowles and Kenna’s team continues to grow alongside BASF to better provide them solutions.</p>
            ...
            <h2 class='kenna-header2'>Conclusion + Acknowledgments</h2>
            <section id='ca' class="text-sections">
                <p>I would like to thank my supervisors Daniel Kostevskii and Nicholas Pulsone for supporting me throughout my work terms, as well as everyone on the Data Management team for being so open and welcoming. All my team members were always there to provide me support and answer any questions. I would like to thank Kenna for fostering such a positive work environment which wouldn’t be the same without all the amazing people that work there. One of the best things about working at Kenna 
                    was the company culture and I would like to thank all the people that planned in-person social events despite the remote work environment.
                    <br/><br/>Working at Kenna was an amazing experience. I made so many amazing connections. I was able to learn a lot about the software development process and view software in a different light. I truly understand the importance of the user's experience thanks to all the QA and software testing I have done.</p>
